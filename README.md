...
Developer documentation (autogenerated from docstrings with Sphinx) can be built as follows:
...
The built html docs will be located in the `docs/_build` directory.
